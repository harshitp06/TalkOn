...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    private fun uploadImageAndUpdateInfo() {
        when {
            imageUri == null -> {
                Toast.makeText(this, "Please selsect image first.", Toast.LENGTH_LONG).show()
            }
            ...
            bio_profile_freg.text.toString() == "" -> {
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if (task.isSuccessful) {
                        ...
                        userMap["bio"] = bio_profile_freg.text.toString()
                        userMap["image"] = myUrL
        ...
        usersRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()) {
                    ...
                    Picasso.get().load(user!!.getImage()).placeholder(R.drawable.profile_image).into(profile_image_view_profile_frag)
                    username_profile_frag.setText(user!!.getUsername())
                    full_name_profile_frag.setText(user!!.getFullname())
                    bio_profile_freg.setText(user!!.getBio())
                }
            }
